...
const dummyNgoData = [
  { id: 1, name: 'Bright Futures Foundation', description: 'Providing education and resources to underprivileged children.', image: 'https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?auto=format&fit=crop&w=1170&q=80', category: 'Child Welfare & Education', location: 'Parel, Mumbai, Maharashtra' },
  ...
  { id: 3, name: 'Healthcare Heroes', description: 'Delivering medical supplies and aid to remote villages.', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1170&q=80', category: 'Healthcare & Nutrition', location: 'Parel, Mumbai, Maharashtra' },
  ...
  { id: 18, name: 'Udyog Pathshala', description: 'Equipping unemployed youth with vocational skills for a better future.', image: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1170&q=80', category: 'Livelihood & Skill Development', location: 'Parel, Mumbai, Maharashtra' },
