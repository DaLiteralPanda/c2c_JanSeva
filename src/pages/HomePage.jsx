...
// --- DATA UPDATED BELOW ---
// The full list of NGOs. I've added the new fields to each one.
import { dummyNgos as dummyNgoData } from '../data/dummyNgos.js';
...
export function HomePage() {
  ...
  console.log('1. Initial Full NGO List:', dummyNgoData);
  console.log('2. Current Filter Values:', { searchTerm, selectedCategories });
  ...
  console.log('3. Final List to Display:', filteredNgos);

  return (
    <>
      <Container size="xl" py="xl" style={{ textAlign: 'center' }}>
        <Title order={1} c="rgba(98, 66, 19, 1)" sx={{ fontSize: '2.5rem', fontWeight: 800 }}>
          Empowering NGOs, Connecting Hearts
        </Title>
        <Text color="dimmed" size="lg" maw={580} mx="auto" mt="xl">
          Discover, connect with, and support verified non-governmental organizations. Your single platform for making a real impact.
